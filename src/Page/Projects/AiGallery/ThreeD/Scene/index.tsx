  ...
  return (
    <group dispose={null}>
      ...
      <RigidBody type='fixed' >
        {/* 中间那排 */}
        <Clone object={nodes['Cube007']} castShadow={true} receiveShadow={true} />
        <Clone object={nodes['Cube008']} castShadow={true} receiveShadow={true} />
        <Clone object={nodes['Cube009']} castShadow={true} receiveShadow={true} />
      ...
      <RigidBody type='fixed' colliders="trimesh">
        {/* 楼梯 */}
        <Clone object={nodes['Cube005']} castShadow={true} receiveShadow={true} />
        <Clone object={nodes['Cube013']} castShadow={true} receiveShadow={true} />
      </RigidBody>
      ...
      <RigidBody type='fixed' colliders="trimesh">
        {/* 墙壁 */}
        <Clone object={nodes['Wall']} castShadow={true} receiveShadow={true} />
        <Image url={image[0]} position={[-4.98, 1.14, 1.56]} rotation={[0, Math.PI / 2, 0]} scale={[6.8, 2.08]} />
      ...
      <RigidBody type='fixed' colliders="trimesh">
        {/* 地面 */}
        <Clone object={nodes['showWall']} castShadow={true} receiveShadow={true} />
        <Clone object={nodes['ceiling_']} castShadow={true} receiveShadow={true} />
      </RigidBody>
    </group>
  )
}
